  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow container mx-auto p-2 flex">
        <div className="w-1/6 border rounded-md bg-blue bg-opacity-[50%] p-6 mr-3">
        ...
        <div className="w-3/4">
          <h1 className="text-2xl font-bold mb-4">Dashboard de Gestión de Residuos</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-6 border rounded-md bg-blue bg-opacity-[18%]">
